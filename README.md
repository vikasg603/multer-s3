...
## Transforming Files Before Upload With Custom Transforms function
...
var upload = multer({
  storage: multerS3({
    ...
    transforms: () => {
      const KeyNamePrefix = 'image-';
      return [{
        id: 'original',
        key: function (req, file, cb) {
          cb(null, KeyNamePrefix + 'original.jpg')
        },
        transform: function (req, file, cb) {
          cb(null, sharp().jpg())
        }
        ...
        id: 'thumbnail',
        key: function (req, file, cb) {
          cb(null, KeyNamePrefix + 'thumbnail.jpg')
        },
        transform: function (req, file, cb) {
          cb(null, sharp().resize(100, 100).jpg())
        }
